...
void Core::Transform::Update()
{
    ...
    m_localToWorld.columns[1].m128_f32[3] = 0.0f; // Assuming homogeneous coordinate for direction vectors is 0
    ...
    m_localToWorld.columns[2].m128_f32[3] = 0.0f; // Assuming homogeneous coordinate for direction vectors is 0
